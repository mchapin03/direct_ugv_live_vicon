...
def generate_launch_description():
    ...
    # Remap cmd_vel globally for all nodes that use it
    remap_cmd_vel = Node(
        package='tf2_ros',  # Dummy package; we just use remappings globally
        executable='static_transform_publisher',  # Dummy executable
        name='dummy_node_for_remap',
        remappings=[
